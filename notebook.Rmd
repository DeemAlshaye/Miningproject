...
var of salary in usd is also really high meaning higher risk
the var of remote ratio is high but not quit high as salary and salary in usd  meaning high risk
...
```{r}
table_mat <- table(data_train$salary_in_usd_disc, predict_unseen)
table_mat
```
...
dt_model <- rpart(myFormula, data = train_set, method = "class", parms = list(split = "information"))

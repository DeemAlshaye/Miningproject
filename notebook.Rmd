...
```{r}
ds_salaries<-read.csv("C:/Users/noram/Downloads/data mining project/ds_salaries.csv")
...
### Encoding
onverting categorical or ordinal variables into a numerical representation that can be used in data analysis and modeling. This transformation is necessary because many machine learning algorithms and statistical techniques require numerical inputs.

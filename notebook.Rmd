...
<<<<<<< HEAD
<<<<<<< HEAD
boxplot(ds_salaries$salary,ylim=c(0,1000000),main="salary")
#box plot represents salaries of employees
```

```{r}
boxplot(ds_salaries$salary_in_usd,ylim=c(0,1000000),main="salary in usd")
#box plot represents salary in (usd)
```

```{r}
boxplot(ds_salaries$remote_ratio,main="remote ratio")
#box plot represents the remote ratio of employees (onsite,online or both)
```

```{r}
boxplot(ds_salaries$work_year,main="work year")
#box plot represents work year (2020,2021,2022,2023)
=======
boxplot(ds_salaries$salary_1000s,ylim=c(0,1000),xlab="Salary",ylab="Salary in 1000s")
```

Box plot represents salaries of employees,it displays the five number summary of the salary it shows that the salary has a lot of outliers thats need to be smoothed to remove the noise
...
<<<<<<< HEAD
<<<<<<< HEAD
hist(ds_salaries$salary,ylim=c(0,100),xlab="salary",main="Histogram of salary")
#histogram represents salaries of employees
=======
...
#barplot represents frequency of job titles, it shows that Data Engineer is the most frequency
ds_salaries$remote_ratio %>% table() %>% barplot(xlab="remote ratio", main="barplot of remote ratio")
#barplot represents frequency of remote ration, it show that the 0(onsite) has the most frequency
...
#the scatter plot represent the redundant in salary and salary in usd, it shows that most of salary and salary in usd are the same value
=======
...
<<<<<<< HEAD
<<<<<<< HEAD
#the pie chart represent the percentages for company size by taking sample of companies, it shows that M(Medium company size) has the highest frequency 
```
```{r}
...
#the pie chart represent the percentages for experience level by taking sample of employees, it shows that SE(Senior level) has the highest frequency 
=======
=======
>>>>>>> e74bb41ee745f6f64653331cde801db8c67fabfe
...
Categorizeing company location:
...
## Removing irrelevant and duplicate attributs from the dataset
...
we decided to remove employee resident due to its being irrelevant to our data

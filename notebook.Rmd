...
we reject the null hypothesis, they are correaltd so we will only take company_location

```{r}
library(tidyvers)
my_data <- ds_salaries %>%
  select(salary,experience_level,employment_type,job_title,salary,salary_currency,company_location,company_size)
  print(my_data)
```
